function   Nao_param = Param01_t_main_StartingDS()
...
ZMPxi = 0;
ZMPxf = -0.000526870443289; %D=0.1
% ZMPxf = -0.000853066106286; %D=0.1
ZMPy0 = D/2;
ZMPyi =  0.07; %0.25
% ZMPyi =  0.09; %t_0.15 
ZMPyf = 0.010687096791726; %D=0.1
% ZMPyf = 0.016675729258272; %D=0.1
% ---------------------------------------------------------------------
