function   Nao_param = Param02_t_main_StartingDS_final()
...
ZMPxIni = 0.012999074215536; %D=0.1
% ZMPxIni = 0.014293730764073; %D=0.1
ZMPxEnd = S-0.005;  
ZMPyIni = 0.018034378622397; %D=0.1
% ZMPyIni = 0.021811455897163; %D=0.1
...
Rcyc = [0.015258162611412,0.036963814495927,0.045654912658783,0.101997140424957]; %ZMP -0.01_-0.01 h_f = 0.02
