function Func = Optim_ObjectiveFunc_Transition_SS_DS_fsolve_4param(R)

global gait_parameters_SS_Transition gait_parameters_DS_Transition gait_parameters_previous_DS Rcyc
...
T_SS = gait_parameters_SS_Transition.T;
T1 = gait_parameters_SS_Transition.Tini;
T2 = gait_parameters_SS_Transition.Tend;
ZMPx_Ini = gait_parameters_SS_Transition.ZMPxIni;  % Fixed value
ZMPy_Ini = gait_parameters_SS_Transition.ZMPyIni;  % Fixed value
...
gait_parameters_SS_Transition.ZMPxCoeff = ZMPxCoeff; % Coefficients for the polynomial trayectory of the ZMP in X
gait_parameters_SS_Transition.ZMPyCoeff = ZMPyCoeff; % Coefficients for the polynomial trayectory of the ZMP in Y
gait_parameters_SS_Transition.ZMPxIni = ZMPx_Ini;   % Initial desired position in X
gait_parameters_SS_Transition.ZMPxMid = ZMPx_SS_Mid;   % middle desired position in X
gait_parameters_SS_Transition.ZMPxEnd = ZMPx_Fin;   % Final desired position in X
gait_parameters_SS_Transition.ZMPyIni = ZMPy_Ini;   % Final desired position in X
gait_parameters_SS_Transition.ZMPyEnd = ZMPy_Fin;   % Final desired position in Y

% ---------------------------------------------------------------------
% Updating parameters for ZMP in the initial DS phase
T_DS = gait_parameters_DS_Transition.T;
T1 = gait_parameters_DS_Transition.Tini;
T2 = gait_parameters_DS_Transition.Tend;
ZMPx_DS_End = gait_parameters_DS_Transition.ZMPxEnd;
ZMPx_DS_Mid = gait_parameters_DS_Transition.ZMPxMid;
ZMPy_DS_End = gait_parameters_DS_Transition.ZMPyEnd;
...
Pos = [T1 ZMPy_SS_End;
       ...
       T2 ZMPy_DS_End];
ZMPyCoeff = findPolyCoeff(Pos,Vel,Acc);
gait_parameters_DS_Transition.ZMPxCoeff = ZMPxCoeff; % Coefficients for the polynomial trayectory of the ZMP in X
gait_parameters_DS_Transition.ZMPyCoeff = ZMPyCoeff; % Coefficients for the polynomial trayectory of the ZMP in Y
gait_parameters_DS_Transition.ZMPxIni = ZMPx_SS_End;   % Initial desired position in X
gait_parameters_DS_Transition.ZMPxMid = ZMPx_DS_Mid;   % Final desired position in X
gait_parameters_DS_Transition.ZMPxEnd = ZMPx_DS_End;   % Final desired position in X
gait_parameters_DS_Transition.ZMPyIni = ZMPy_SS_End;   % Initial desired position in Y
gait_parameters_DS_Transition.ZMPyMid = ZMPy_DS_Mid;   % Initial desired position in Y
gait_parameters_DS_Transition.ZMPyEnd = ZMPy_DS_End;   % Final desired position in Y
...
[t,Xt,t_SS,Xt_SS,t_DS,Xt_DS,gait_parameters_SS_Transition,gait_parameters_DS_Transition,] = ...
    robot_step_EssModel_Stopping_SS_DS_t(X_final,gait_parameters_SS_Transition,gait_parameters_DS_Transition);
