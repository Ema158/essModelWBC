function Func = Optim_ObjectiveFunc_Starting_DS_SS_DS_fsolve_Internal_State_x(R)
...
x0 = gait_parameters_DS.x0;
xmid = gait_parameters_DS.xmid;
xf = gait_parameters_DS.xf;
...
x0 = gait_parameters_SS.x0;
xf = gait_parameters_SS.xf;
...
x0 = gait_parameters_DS_final.x0;
xf = gait_parameters_DS_final.xf;
...
[t,Xt,t_SS,Xt_SS,t_DS,Xt_DS,t_DS_final,Xt_DS_final,gait_parameters_SS,gait_parameters_DS,gait_parameters_DS_final] = ...
    robot_step_EssModel_Start_DS_SS_DS_Internal_State_x(gait_parameters_SS,gait_parameters_DS,gait_parameters_DS_final);
