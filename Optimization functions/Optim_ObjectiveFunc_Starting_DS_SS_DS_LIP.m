function Func = Optim_ObjectiveFunc_Starting_DS_SS_DS_LIP(R)

global gait_parameters_Starting_DS gait_parameters_Starting_SS gait_parameters_Starting_DS_final
...
T = gait_parameters_Starting_DS.T;
T1 = gait_parameters_Starting_DS.Tini;
T2 = gait_parameters_Starting_DS.Tend;
ZMPy_Ini = gait_parameters_Starting_DS.ZMPyIni;  % Fixed value
ZMPy_Mid = gait_parameters_Starting_DS.ZMPyMid;  % Fixed value
...
gait_parameters_Starting_DS.ZMPxCoeff = ZMPxCoeff; % Coefficients for the polynomial trayectory of the ZMP in X
gait_parameters_Starting_DS.ZMPyCoeff = ZMPyCoeff; % Coefficients for the polynomial trayectory of the ZMP in Y
gait_parameters_Starting_DS.ZMPxIni = ZMPx_1;   % Initial desired position in X
gait_parameters_Starting_DS.ZMPxEnd = ZMPx_1;   % Final desired position in X
gait_parameters_Starting_DS.ZMPyEnd = ZMPy_1;   % Final desired position in Y

% ---------------------------------------------------------------------
% Updating parameters for ZMP in the initial SS phase
T = gait_parameters_Starting_SS.T;
T1 = gait_parameters_Starting_SS.Tini;
T2 = gait_parameters_Starting_SS.Tend;
T_SS = gait_parameters_Starting_SS.T;
T_DS = gait_parameters_Starting_DS.T;
% Time at which the ZMP will stop its motion (it should be <= T)
Pos = [T1 ZMPx_1;
       T2 ZMPx_2];
Vel = [];
...
Pos = [T1 ZMPy_1;
       T2 ZMPy_2];
ZMPyCoeff = findPolyCoeff(Pos,Vel,Acc);
gait_parameters_Starting_SS.ZMPxCoeff = ZMPxCoeff; % Coefficients for the polynomial trayectory of the ZMP in X
gait_parameters_Starting_SS.ZMPyCoeff = ZMPyCoeff; % Coefficients for the polynomial trayectory of the ZMP in Y
gait_parameters_Starting_SS.ZMPxIni = ZMPx_1;   % Initial desired position in X
gait_parameters_Starting_SS.ZMPxEnd = ZMPx_2;   % Final desired position in X
gait_parameters_Starting_SS.ZMPyIni = ZMPy_1;   % Initial desired position in Y
gait_parameters_Starting_SS.ZMPyEnd = ZMPy_2;   % Final desired position in Y

% ---------------------------------------------------------------------
% Updating parameters for ZMP in the final DS phase
T = gait_parameters_Starting_DS_final.T;
T1 = gait_parameters_Starting_DS_final.Tini;
T2 = gait_parameters_Starting_DS_final.Tend;
ZMPx_End_DSfinal = gait_parameters_Starting_DS_final.ZMPxEnd;  % this value correspond to the initial ZMP in X of the cyclic motion
ZMPy_End_DSfinal = gait_parameters_Starting_DS_final.ZMPyEnd;  % this value correspond to the initial ZMP in Y of the cyclic motion
ZMPy_Mid_DSfinal = gait_parameters_Starting_DS_final.ZMPyMid;
% Time at which the ZMP will stop its motion (it should be <= T)
Pos = [T1 ZMPx_2;
       T2 ZMPx_End_DSfinal];
Vel = [];
...
gait_parameters_Starting_DS_final.ZMPxIni = ZMPx_2;   % Initial desired position in X
gait_parameters_Starting_DS_final.ZMPyIni = ZMPy_2;   % Initial desired position in Y

%% Robot initial step DS and SS (Starting from REST)
[t,Xt,t_SS,Xt_SS,t_DS,Xt_DS,t_DS_final,Xt_DS_final,gait_parameters_Starting_SS,gait_parameters_Starting_DS,gait_parameters_Starting_DS_final] = ...
    robot_step_LIPModel_Start_DS_SS_DS_t(gait_parameters_Starting_SS,gait_parameters_Starting_DS,gait_parameters_Starting_DS_final);
