function Func = Optim_ObjectiveFunc_Stopping_SS_DS_fsolve_4param_Impact_Circ(R)
...
T = gait_parameters_previous_DS.T;
[q_end,qp_end,~,~,~] = JointsPosVel_from_CoMPosVel_HZDtime([xf;yf],[xpf;ypf],robot,gait_parameters_previous_DS,T);
...
[qfp0,robot] = impact_Pos_Vel(robot,gait_parameters_previous_DS.v_foot_f); %
