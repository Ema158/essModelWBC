function Func = Optim_ObjectiveFunc_Starting_ZMPyi_DS(R)
...
ZMPy_1 = R(2); % Proposed ZMP in Y for Middle DS
ZMPx_2 = R(3); % Proposed ZMP in X for final of SS and initial of DS_final
ZMPy_2 = R(4); % Proposed ZMP in Y for initial of SS and initial of DS_final
...
gait_parameters_DS.ZMPyEnd = 0;   % Final desired position in Y
...
gait_parameters_SS.ZMPyIni = ZMPy_2;   % Initial desired position in Y
gait_parameters_SS.ZMPyEnd = 0;   % Final desired position in Y
...
gait_parameters_DS_final.ZMPyIni = 0;   % Initial desired position in Y
