function Func = Optim_ObjectiveFunc_Starting_DS_SS_DS_fsolve_5_param(R)
...
% -----------------------------------------------   
ZMPy_Mid_DS = R(1);
ZMPx_1 = R(2); % Proposed ZMP in X for initial, intermediate and final in DS AND initial of SS
ZMPy_1 = R(3); % Proposed ZMP in Y for final in DS initial of SS
ZMPx_2 = R(4); % Proposed ZMP in X for final of SS and initial of DS_final
ZMPy_2 = R(5); % Proposed ZMP in Y for final of SS and initial of DS_final

fprintf('Proposed ZMPy for midle DS:  \nZMPy_Mid = %f.\n',ZMPy_Mid_DS)
