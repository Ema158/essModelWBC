function Func = Optim_ObjectiveFunc_Stopping_SS_DS_fsolve(R)
...
ZMPx_SS_End = R(1); % Proposed ZMP in X for initial, intermediate and final in DS AND initial of SS
ZMPy_SS_End = R(2); % Proposed ZMP in Y for final in DS initial of SS
ZMPx_DS_End = R(3); % Proposed ZMP in X for final of SS and initial of DS_final
ZMPy_DS_End = R(4); % Proposed ZMP in Y for final of SS and initial of DS_final

fprintf('Proposed ZMP for final SS:  \nZMPx = %f, \nZMPy = %f.\n',ZMPx_SS_End,ZMPy_SS_End )
fprintf('Proposed ZMP for final DS:  \nZMPx = %f, \nZMPy = %f.\n',ZMPx_DS_End,ZMPy_DS_End)
fprintf('-----------------------------------------------------\n')
