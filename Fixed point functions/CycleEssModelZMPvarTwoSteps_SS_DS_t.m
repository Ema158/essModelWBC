function Func = CycleEssModelZMPvarTwoSteps_SS_DS_t(R)
...
global gait_parameters_step1_SS gait_parameters_step1_DS gait_parameters_step2_SS gait_parameters_step2_DS
DxProp = R(1); % Proposed displacement in X
DyProp = R(2); % Proposed displacement in Y
...
T = gait_parameters_step1_SS.T;
S = gait_parameters_step1_SS.S;
D = gait_parameters_step1_SS.D;
...
gait_parameters_PreviousStep = gait_parameters_step2_DS;
gait_parameters_SS_CurrentStep = gait_parameters_step1_SS;
gait_parameters_DS_CurrentStep = gait_parameters_step1_DS;
...
[t_step1,X0_step1,Xt_step1,t_SS_step1,Xt_SS_Step1,t_DS_step1,Xt_DS_step1] = robot_TwoDiffSteps_SS_DS_EssModel_t(X_final,gait_parameters_SS_CurrentStep,gait_parameters_DS_CurrentStep,gait_parameters_PreviousStep); % "robot" structures are needed inside
...
gait_parameters_step1_DS = gait_parameters;

disp('SECOND STEP')
% gait_parameters = gait_parameters_step1;
gait_parameters_PreviousStep = gait_parameters_step1_DS;
gait_parameters_SS_CurrentStep = gait_parameters_step2_SS;
gait_parameters_DS_CurrentStep = gait_parameters_step2_DS;
...
[t_step2,X0_step2,Xt_step2,t_SS_step2,Xt_SS_step2,t_DS_step2,Xt_DS_step2] = robot_TwoDiffSteps_SS_DS_EssModel_t(X_final,gait_parameters_SS_CurrentStep,gait_parameters_DS_CurrentStep,gait_parameters_PreviousStep); % "robot" structures are needed inside
% % Initial states (current step) after impact
% x0_step2 = X0_step2(1);
% y0_step2 = X0_step2(2);
...
gait_parameters_step2_DS = gait_parameters;
