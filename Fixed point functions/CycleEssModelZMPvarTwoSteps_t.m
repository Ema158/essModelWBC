function Func = CycleEssModelZMPvarTwoSteps_t(R)
...
[t_step1,X0_step1,Xt_step1] = robot_TwoDiffSteps_EssModel_t(X_final,gait_parameters_CurrentStep,gait_parameters_PreviousStep); % "robot" structures are needed inside
...
[t_step2,X0_step2,Xt_step2] = robot_TwoDiffSteps_EssModel_t(X_final,gait_parameters_CurrentStep,gait_parameters_PreviousStep); % "robot" structures are needed inside
% % Initial states (current step) after impact
% x0_step2 = X0_step2(1);
% y0_step2 = X0_step2(2);
