function   Nao_param = Param28_t_StartingDS_final()
...
ZMPxIni = 0.005305321998414; %ZMP -0.01_-0.01 h_f = 0.02
ZMPxEnd = S-0.005;  
% ZMPyIni = -0.000441864635570; %ZMP 0_0 h_f = 0.02
ZMPyIni = 0.001904076655177; %ZMP -0.01_-0.01 h_f = 0.02
...
Rcyc = [0.014471243701861,0.029277245534219,0.049286964002391,0.102087594189047]; %ZMP -0.01_-0.01 h_f = 0.02
