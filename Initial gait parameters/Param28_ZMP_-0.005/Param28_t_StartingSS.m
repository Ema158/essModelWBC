function   Nao_param = Param28_t_StartingSS()
...
ZMPx0 = -0.000680659112085;  %ZMP -0.01_-0.01 h_f = 0.02
% ZMPxf = -0.000252257574178;  %ZMP 0_0 h_f = 0.02
ZMPxf = 0.005305321998414;  %ZMP -0.01_-0.01 h_f = 0.02
% ZMPy0 = 0.004882290896382;   %ZMP 0_0 h_f = 0.02
ZMPy0 = 0.005483554833708;   %ZMP -0.01_-0.01 h_f = 0.02
ZMPyi = 0;
% ZMPyf = -0.000441864635570; %ZMP 0_0 h_f = 0.02
ZMPyf = 0.001904076655177;  %ZMP -0.01_-0.01 h_f = 0.02
% ---------------------------------------------------------------------
