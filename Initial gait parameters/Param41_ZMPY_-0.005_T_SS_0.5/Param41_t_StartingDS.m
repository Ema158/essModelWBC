function   Nao_param = Param41_t_StartingDS()
...
ZMPxi = 0;
ZMPxf = -0.000191350581780; %T 0.8
% ZMPxf = -0.000211108645823; %T 0.7
ZMPy0 = D/2;
ZMPyi =  0.075; %0.25
% ZMPyi =  0.09; %t_0.15 
ZMPyf = 0.012631580756010; % T 0.8
% ZMPyf = 0.014068559954970; % T 0.7
% ---------------------------------------------------------------------
