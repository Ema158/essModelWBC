function   Nao_param = Param41_t_StartingDS_final()
...
ZMPxIni = -0.000493810046538; %T 0.8
% ZMPxIni = -0.000213413802946; %T 0.7
ZMPxEnd = S-0.005;  
ZMPyIni = 0.002918884044167; %T 0.8
% ZMPyIni = -0.005654562598363; %T 0.7
...
Rcyc = [0.008344749390951,0.031588181717548,0.031812737860120,0.099235423500276]; %T 0.8
% Rcyc = [0.008268103700045,0.031454042750395,0.031483202863899,0.098379607773789]; %ZMP T_0.7
