function   Nao_param = Param41_t_StartingSS()
...
H_ffoot = 0.018;  % Foot maximum hight 
...
ZMPx0 = -0.000191350581780;  %T 0.8
% ZMPx0 = -0.000211108645823;  %T 0.7
ZMPxf = -0.000493810046538;  %T 0.8
% ZMPxf = -0.000213413802946;  %T 0.7
ZMPy0 = 0.012631580756010;   %T 0.8
% ZMPy0 = 0.014068559954970;   %T 0.7
ZMPyi = 0;
ZMPyf = 0.002918884044167; %T 0.8
% ZMPyf = -0.005654562598363; %T 0.7
% ---------------------------------------------------------------------
