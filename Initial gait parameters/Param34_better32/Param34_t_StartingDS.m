function   Nao_param = Param34_t_StartingDS()
...
ZMPxi = 0;
ZMPxf = -0.000098250738517; %z 0.26
% ZMPxf = -0.000011213303363; %z 0.255
ZMPy0 = D/2;
ZMPyi =  0.075; %z 0.26,0.255
% ZMPyi =  0.09; % 
ZMPyf = 0.014460914630386; %z 0.26
% ZMPyf = 0.013885145625506; %z 0.255
% ---------------------------------------------------------------------
