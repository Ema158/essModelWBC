function   Romeo_param = Param13b_t_DS_NOimpact_ZMPvar_HipTorsoArmsNeck()
...
ZMPxIni = 0.1; %-0.02;      % Local position of the desired ZMP in X for each step
ZMPxEnd = S-0.02;
...
gait_parameters.Step_length = 0;   % Distance traveled in X by the free foot to reach the final position in X
...
gait_parameters.Pitch_ffoot_inc = deg2rad(0);  % Rotation in Y to be performed by the free foot to reach its final orientation in Y
...
gait_parameters.RShoulder_Pitch_i = Shoulder_Pitch_f; % Initial orientation of the right shoulder around Y 
gait_parameters.RShoulder_Pitch_f = Shoulder_Pitch_f; % Final orientation of the right shoulder around Y 
% % Left shoulder pitch
gait_parameters.LShoulder_Pitch_i = Shoulder_Pitch_i; % Initial orientation of the left shoulder around Y 
...
gait_parameters.Yaw_torso_inc = 0;  % Desired rotation in Z to be performed by the torso to reach its final orientation in Z
% % Neck yaw
