function   Nao_param = SSParam08_t_StartingSS()
...
ZMPx0 = -0.000171084171994; %Transition = false
% ZMPxf = -0.004409679313396; %Transition = true
ZMPxf = -0.004932281881977; %Transition = false
% ZMPy0 = 0.017702175161853; %Transition = true
ZMPy0 = 0.024460919464826; %Transition = false
ZMPyi = 0;
% ZMPyf = 0.001431706418219; %Transition = true
ZMPyf = 0.000846883228478; %Transition = false
% ---------------------------------------------------------------------
