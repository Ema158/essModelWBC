function   Nao_param = SSParam08_t_StartingDS_final()
...
ZMPxIni = -0.004932281881977; %Transition = false
ZMPxEnd = S-0.005;  
% ZMPyIni = 0.001431706418219; %Transition = true
ZMPyIni = 0.000846883228478; %Transition = false
ZMPyMid = 0.0425; 
ZMPyEnd = D;  
Pos = [T1 ZMPxIni; 
%        T/2 ZMPxMid;
...
Rcyc = [-0.004137571260956,0.000037478342144,0.127794817066010,0.232590381337595]; %Transition=false
