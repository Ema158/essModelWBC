function   Nao_param = SSLIPParam09e_t_StartingDS_final()
...
% ZMPxIni = -0.004409679313396; %Transition = true
ZMPxIni = 0.003240693890438; %Transition = false
ZMPxEnd = S-0.005;  
% ZMPyIni = 0.001431706418219; %Transition = true
ZMPyIni = -0.000800673719389; %Transition = false
ZMPyMid = 0.0425; 
ZMPyEnd = D;  
Pos = [T1 ZMPxIni; 
%        T/2 ZMPxMid;
...
Rcyc = [0.002499995423756,0.000000010185296,0.144850172569479,0.283417686380016]; %Transition=false
