function   Nao_param = SSLIPParam09e_t_StartingDS()
...
ZMPxi = 0;
% ZMPxf =  0.000033099834640; %Transition = true
ZMPxf =  -0.000113976194142; %Transition = false
ZMPy0 = D/2;
% ZMPyi =  0.085; %Bueno
ZMPyi =  0.075;
% ZMPyf = 0.017702175161853;% Transition = true
ZMPyf = 0.018031381739405;% Transition = false
% ---------------------------------------------------------------------
