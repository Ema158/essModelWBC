function   Nao_param = SSParam12_ZMPx_var()
...
% Rcyc = [-0.000603988360851,0.000142461528685,0.245385318014524,0.234124335836574]; % S=0.1
% Rcyc = [-0.000848214663217,0.000133891646315,0.258147485022948,0.233509594251468]; % S=0.105
% Rcyc = [-0.006635125666615,-0.000021442204542,0.285424806079511,0.232893891212095]; % S=0.11
% Rcyc = [-0.006965804308927,-0.000068815555667,0.298446257710798,0.232161954849265]; % S=0.115
Rcyc = [-0.007328574156373,-0.000130542643558,0.3115865321726708,0.231381301041618]; % S=0.12
% Rcyc = [-0.007328574156373,-0.000130542643558,0.3115865321726708,0.231381301041618]; % S=0.125 no funciona
