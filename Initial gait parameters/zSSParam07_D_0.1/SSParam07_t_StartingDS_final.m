function   Nao_param = SSParam07_t_StartingDS_final()
...
ZMPxIni = -0.004392842451042; %Transition = false
ZMPxEnd = S-0.005;  
% ZMPyIni = 0.001431706418219; %Transition = true
ZMPyIni = 0.000764998657434; %Transition = false
ZMPyMid = 0.0425; 
ZMPyEnd = D;  
Pos = [T1 ZMPxIni; 
%        T/2 ZMPxMid;
...
Rcyc = [-0.004027333789865,0.000085582323377,0.128614211052360,0.238546395956752]; %Transition=false
