function   Nao_param = Param26b_t_StartingDS_final()
...
ZMPxIni = 0.021351147405310; %ZMP -0.01_-0.01 h_f = 0.02
ZMPxEnd = S-0.005;  
% ZMPyIni = -0.000441864635570; %ZMP 0_0 h_f = 0.02
ZMPyIni = 0.032783390320146; %ZMP -0.01_-0.01 h_f = 0.02
...
Rcyc = [0.012173170055737,0.027839675728655,0.060356053755865,0.119277294542261]; %ZMP -0.01_-0.01 h_f = 0.02
