function   Nao_param = Param26b_t_StartingDS()
...
ZMPx0 = -0.001953516640582; %ZMP -0.01_0.01 h_f = 0.02
ZMPxi = 0;
% ZMPxf = -0.000450175580890; %ZMP 0_0 h_f = 0.02
ZMPxf = -0.001953516640582; %ZMP -0.01_-0.01 h_f = 0.02
ZMPy0 = D/2;
% ZMPyi =  0.085; %Bueno
ZMPyi =  0.1;
% ZMPyf = 0.004882290896382; %ZMP 0_0 h_f = 0.02
ZMPyf = 0.007978966018941; %ZMP -0.01_-0.01 h_f = 0.02
% ---------------------------------------------------------------------
