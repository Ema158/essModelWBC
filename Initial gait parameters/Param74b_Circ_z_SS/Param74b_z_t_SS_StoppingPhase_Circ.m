function   Nao_param = Param74b_z_t_SS_StoppingPhase_Circ(rotated)
...
ZMPyi = 0; %not used
if rotated == true
    ZMPxi = 0.004212275175989;
    ZMPxf = 0.003655708169561;
    ZMPyf = -0.007765605145609;
else
    ZMPxi =  0.000110213652726;
    ZMPxf =  0.005784912191717;
    ZMPyf = -0.001223963915965;
end
% ---------------------------------------------------------------------
