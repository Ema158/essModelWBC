...
% Rcyc = [0,0,0.08,0.23]; % 
%Rcyc = [0,0,0.07,0.24]; % Funciona
%Rcyc = [-0.0013866  0.00027159    0.078466     0.23692]; %Funciona mejor que el de arriba J=1.65
%Rcyc = [-1.384055e-03,2.604667e-04,7.845084e-02,2.369689e-01]; %Valores encontrados con el programa M40
Rcyc = [-1.384055e-03,2.604667e-04,1.245084e-01,2.369689e-01]; %Valores encontrados con el programa M40
