function   Nao_param = Param33_t_StartingSS()
...
ZMPx0 = 0.000571783199639;  %ZMP -0.01_-0.01 h_f = 0.02
% ZMPxf = -0.000252257574178;  %ZMP 0_0 h_f = 0.02
ZMPxf = -0.007327727512284;  %ZMP -0.01_-0.01 h_f = 0.02
% ZMPy0 = 0.004882290896382;   %ZMP 0_0 h_f = 0.02
ZMPy0 = 0.020101681290609;   %ZMP -0.01_-0.01 h_f = 0.02
ZMPyi = 0;
% ZMPyf = -0.000441864635570; %ZMP 0_0 h_f = 0.02
ZMPyf = -0.028763554950559;  %ZMP -0.01_-0.01 h_f = 0.02
% ---------------------------------------------------------------------
