function   Nao_param = Param70c_t_DS_NOimpact_ZMPvar_circ_Step2()
...
gait_parameters.Yaw_ffoot_i = deg2rad(10);     % Initial rotation in Z of the free foot
...
gait_parameters.Yaw_ffoot_f = deg2rad(10); % Rotation in Z to be performed by the free foot to reach its final orientation in Z
% Hip yaw
