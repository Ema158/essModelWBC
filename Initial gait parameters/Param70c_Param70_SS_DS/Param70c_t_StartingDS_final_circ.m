function   Nao_param = Param70c_t_StartingDS_final_circ()
...
% ZMPyEnd = D; 
%
ZMPxIni = 0.003633601324089; %0.25
ZMPxEnd = S-0.005;  
ZMPyIni = 0.014712231069299; %0.25
ZMPyMid = 0.0425; %Puede usarse o no
ZMPyEnd = D; 
Pos = [T1 ZMPxIni; 
%        T/2 ZMPxMid;
...
Rcyc = [-0.008537358373333,0.011722709142279,0.137414260373629,0.234188714768973];
