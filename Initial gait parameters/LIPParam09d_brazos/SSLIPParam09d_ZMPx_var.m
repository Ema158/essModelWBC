function   Nao_param = SSLIPParam09d_ZMPx_var()
...
ZMPxEnd =  0.01;
ZMPyIni =  0.008;      % Local position of the desired ZMP in Y for each step
ZMPyEnd =  0.008;
Pos = [T1 ZMPxIni;       
       T2 ZMPxEnd];
Vel = [T1 0
...
Rcyc = [0.002499989202057,0.000000011609761,0.238456037075278,0.243861313452625]; %S = 0.1
