function   Nao_param = Param27_t_StartingSS()
...
ZMPx0 = 0.000468612317896;  %ZMP -0.01_-0.01 h_f = 0.02
% ZMPxf = -0.000252257574178;  %ZMP 0_0 h_f = 0.02
ZMPxf = -0.009469581477461;  %ZMP -0.01_-0.01 h_f = 0.02
% ZMPy0 = 0.004882290896382;   %ZMP 0_0 h_f = 0.02
ZMPy0 = 0.021194578823117;   %ZMP -0.01_-0.01 h_f = 0.02
ZMPyi = 0;
% ZMPyf = -0.000441864635570; %ZMP 0_0 h_f = 0.02
ZMPyf = -0.031625958918530;  %ZMP -0.01_-0.01 h_f = 0.02
% ---------------------------------------------------------------------
