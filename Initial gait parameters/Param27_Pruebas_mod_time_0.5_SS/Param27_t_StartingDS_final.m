function   Nao_param = Param27_t_StartingDS_final()
...
ZMPxIni = -0.009469581477461; %ZMP -0.01_-0.01 h_f = 0.02
ZMPxEnd = S-0.005;  
% ZMPyIni = -0.000441864635570; %ZMP 0_0 h_f = 0.02
ZMPyIni = -0.031625958918530; %ZMP -0.01_-0.01 h_f = 0.02
...
Rcyc = [0.004708220960622,0.017615191385977,0.100029219850558,0.201518925679006]; %ZMP -0.01_-0.01 h_f = 0.02
