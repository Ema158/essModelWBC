function   Nao_param = Param26_t_StartingDS_final()
...
% ZMPxIni = -0.000252257574178; %ZMP 0_0 h_f = 0.02
ZMPxIni = -0.000340153076692; %ZMP -0.01_-0.01 h_f = 0.02
ZMPxEnd = S-0.005;  
% ZMPyIni = -0.000441864635570; %ZMP 0_0 h_f = 0.02
ZMPyIni = -0.011491681103262; %ZMP -0.01_-0.01 h_f = 0.02
...
Rcyc = [0.011823227946702,0.033093916477092,0.060376208624826,0.143287551410834]; %ZMP -0.01_-0.01 h_f = 0.02
