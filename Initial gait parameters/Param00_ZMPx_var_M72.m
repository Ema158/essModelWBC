...
ZMPxIni =  S-0.01;      % Local position of the desired ZMP in X for each step
ZMPxEnd =  S+0.02;
ZMPyIni =  D+0.01;      % Local position of the desired ZMP in Y for each step
ZMPyEnd =  D+0.01;
Pos = [T1 ZMPxIni;       
       T2 ZMPxEnd];
Vel = [T1 0;    
...
Rcyc = [0.004363796244766,0.000513554148045,0.091680076977883,0.192645053971891];
