function   Nao_param = Param72_t_SS_NOimpact_ZMPvar_circ_PitchHip_Step1()
...
Yaw_ffoot_i = deg2rad(10); % Initial orientation of the free foot w.r.t. the support frame (right foot)
...
% Hip pitch
gait_parameters.Hip_Pitch_i = deg2rad(10);   % Initial orientation of the hip around Z 
gait_parameters.Hip_Pitch_f = deg2rad(0);  % Final orientation of the hip around Z 
...
Rcyc = [-0.004962781256690,-1.928112710320035e-04,0.207194030942535,0.236149416291123]; % q6,q7   10 grados
% Rcyc = [-0.012731729674448,0.003805839952296,0.097341179738588,0.233315871497785] %Prueba
% Rcyc = [-0.009488677523942,0.004781304619191,0.115918039873466,0.236693326398996];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Aviso
%Estos valores no son las condiciones iniciales, estos valores se usan en
%la oprimización de la etapa de detención para el caso en el que el número
%de pasos es impar
