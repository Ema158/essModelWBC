function   Nao_param = Param72_t_SS_NOimpact_ZMPvar_circ_PitchHip_Step2()
...
% Hip roll
gait_parameters.Hip_Roll_i = deg2rad(0);   % Initial orientation of the hip around Z 
gait_parameters.Hip_Roll_f = deg2rad(0);  % Final orientation of the hip around Z 
% Hip pitch
gait_parameters.Hip_Pitch_i = deg2rad(0);   % Initial orientation of the hip around Z 
gait_parameters.Hip_Pitch_f = deg2rad(10);  % Final orientation of the hip around Z 
...
Rcyc = [-0.015819372108124,0.004871610062082,0.168252094368311,0.268480166548315]; % q6,q7   10 grados 
