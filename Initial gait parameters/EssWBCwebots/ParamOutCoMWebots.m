function   Nao_param = ParamOutCoMWebots()
...
T = 1;   %4      % Time step
Thorizon = 0.5;
Tmuestreo = 0.01; %Time step for optimization in the LIP model. 0.005
...
Q = eye(12,12);
%
Q(3:10,3:10) = 0.0001*eye(8,8); % 
Q(11,11) = 0.01; % 
Q(12,12) = 0.01; % 
%
% Q(3:10,3:10) = 0.00001*eye(8,8); % 
% Q(11,11) = 0.00045; % 
% Q(12,12) = 0.00045; % 
%
% Q(3:10,3:10) = 0.0001*eye(8,8); % 
...
%
% Kp = 5*eye(12,12); %Bueno push recovery 10
% Kd = 4.47*eye(12,12); %Bueno push recovery 7
%
...
Rcyc = [0,0,1.6,-0.35,1.6,0.15,1.6,0.35,-1.6,-0.15,0,0,... %x,y,q13,q14,q15,q16,q17,q18,q19,q20,
