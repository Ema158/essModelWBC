function   Nao_param = Param30_t_StartingDS_final()
...
ZMPxIni = 0.020926909074741; %ZMP -0.01_-0.01 h_f = 0.02
ZMPxEnd = S-0.005;  
% ZMPyIni = -0.000441864635570; %ZMP 0_0 h_f = 0.02
ZMPyIni = 0.030900190438578; %ZMP -0.01_-0.01 h_f = 0.02
...
Rcyc = [0.012062839435942,0.026868084652812,0.061025737692231,0.136822164574583]; %ZMP -0.01_-0.01 h_f = 0.02
