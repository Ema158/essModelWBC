function   Nao_param = Param30_t_StartingSS()
...
ZMPx0 = -0.001913828821043;  %ZMP -0.01_-0.01 h_f = 0.02
% ZMPxf = -0.000252257574178;  %ZMP 0_0 h_f = 0.02
ZMPxf = 0.020926909074741;  %ZMP -0.01_-0.01 h_f = 0.02
% ZMPy0 = 0.004882290896382;   %ZMP 0_0 h_f = 0.02
ZMPy0 = 0.008392628742897;   %ZMP -0.01_-0.01 h_f = 0.02
ZMPyi = 0;
% ZMPyf = -0.000441864635570; %ZMP 0_0 h_f = 0.02
ZMPyf = 0.030900190438578;  %ZMP -0.01_-0.01 h_f = 0.02
% ---------------------------------------------------------------------
