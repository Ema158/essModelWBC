function   Nao_param = SSParam04_t_StartingDS_final()
...
ZMPxIni = -0.004393965257752; %Transition = false
ZMPxEnd = S-0.005;  
% ZMPyIni = 0.001431706418219; %Transition = true
ZMPyIni = 0.001399494407852; %Transition = false
ZMPyMid = 0.0425; 
ZMPyEnd = D;  
Pos = [T1 ZMPxIni; 
%        T/2 ZMPxMid;
...
Rcyc = [-0.003996142503563,0.000090066035252,0.128868639596026,0.227041373364736]; %Transition=false
