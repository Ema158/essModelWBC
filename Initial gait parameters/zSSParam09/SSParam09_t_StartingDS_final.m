function   Nao_param = SSParam09_t_StartingDS_final()
...
ZMPxIni = 0.004476428419355; %Transition = false
ZMPxEnd = S-0.005;  
% ZMPyIni = 0.001431706418219; %Transition = true
ZMPyIni = 0.000844053100804; %Transition = false
ZMPyMid = 0.0425; 
ZMPyEnd = D;  
Pos = [T1 ZMPxIni; 
%        T/2 ZMPxMid;
...
Rcyc = [0.001126927367444,0.000097656999786,0.115101127021728,0.238293654467431]; %Transition=false
