function   Nao_param = SSParam09b_t_StartingDS_final()
...
ZMPxIni = 0.004114071419097; %Transition = false
ZMPxEnd = S-0.005;  
% ZMPyIni = 0.001431706418219; %Transition = true
ZMPyIni = 0.000415258983973; %Transition = false
ZMPyMid = 0.0425; 
ZMPyEnd = D;  
Pos = [T1 ZMPxIni; 
%        T/2 ZMPxMid;
...
Rcyc = [0.000868662644322,-0.000307442075175,0.115797372118907,0.239177079411870]; %Transition=false
