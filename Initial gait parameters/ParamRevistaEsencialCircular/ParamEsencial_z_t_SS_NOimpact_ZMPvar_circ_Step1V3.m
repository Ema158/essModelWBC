function   Nao_param = ParamEsencial_z_t_SS_NOimpact_ZMPvar_circ_Step1V3()
...
Yaw_ffoot_i = deg2rad(20); % Initial orientation of the free foot w.r.t. the support frame (right foot)
...
Rcyc = [-0.005953698182469,-0.001370924455475,0.194389242457592,0.219804876249759]; % q6,q7   10 grados 
