function   Nao_param = ParamEsencial_z_t_SS_NOimpact_ZMPvar_circ_Step2V4()
...
Yaw_ffoot_f = deg2rad(30); % final orientation of the free foot w.r.t. the support frame (right foot)
...
a_z = -0.01;      % Maximum amplitude oscillation of the CoM
...
Rcyc = [-0.024632262871737,0.009430006700297,0.0012914603482244,0.312032115797166]; % q6,q7   10 grados 
