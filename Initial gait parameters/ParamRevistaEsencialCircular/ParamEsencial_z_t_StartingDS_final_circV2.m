function   Nao_param = ParamEsencial_z_t_StartingDS_final_circV2()
...
RShoulder_Pitch_i = -0.2;%q13 Q11
RShoulder_Pitch_f = -0.2;%q13 Q11
%\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
LShoulder_Pitch_i = 1.2;%q17 Q15
...
%
ZMPxIni = -0.006683797487413; %0.25
ZMPxEnd = ffoot_pos_f_1(1)-0.005;  
ZMPyIni = -0.000742205815980; %0.25
ZMPyMid = 0.0425; %Puede usarse o no
ZMPyEnd = ffoot_pos_f_1(2)+0.005; 
Pos = [T1 ZMPxIni; 
%        T/2 ZMPxMid;
       T2 ZMPxEnd];
Vel = [];
...
Rcyc = [-0.024632262871737,0.009430006700297,0.102914603482244,0.290032115797166]; % q6,q7   10 grados 
% Rcyc = [-0.009488677523942,0.004781304619191,0.115918039873466,0.236693326398996];
