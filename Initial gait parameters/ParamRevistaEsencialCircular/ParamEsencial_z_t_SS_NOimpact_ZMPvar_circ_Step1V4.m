function   Nao_param = ParamEsencial_z_t_SS_NOimpact_ZMPvar_circ_Step1V4()
...
Yaw_ffoot_i = deg2rad(30); % Initial orientation of the free foot w.r.t. the support frame (right foot)
