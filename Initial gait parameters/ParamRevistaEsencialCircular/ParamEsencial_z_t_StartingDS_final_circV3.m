function   Nao_param = ParamEsencial_z_t_StartingDS_final_circV3()
...
%
ZMPxIni = -0.006906159727000; %0.25
ZMPxEnd = ffoot_pos_f_1(1)-0.005;  
ZMPyIni = -0.005742519771140; %0.25
ZMPyMid = 0.0425; %Puede usarse o no
ZMPyEnd = ffoot_pos_f_1(2)+0.01; 
Pos = [T1 ZMPxIni; 
%        T/2 ZMPxMid;
       T2 ZMPxEnd];
Vel = [];
...
Rcyc = [-0.025422421220625,0.009293570439667,0.099337205639134,0.311368328804874]; % q6,q7   10 grados 
