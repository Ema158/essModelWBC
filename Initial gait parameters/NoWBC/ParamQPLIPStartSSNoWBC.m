function   Nao_param = ParamQPLIPStartSSNoWBC()
...
T1 = 0;
T2 = T;
FzIni = 4.93473*g; %mass*gravity
FzMid = (4.9347-0.1)*g; 
FzEnd = (4.9347+10)*g; 
Pos = [T1 FzIni; 
       (T/2) FzIni;
       T2 FzIni];
FzCoeff = findPolyCoeff(Pos,[],[]);
gait_parameters.FzCoeff = FzCoeff;
...
gait_parameters.magnitudeDisturbance = 30; %Acc
...
Rcyc = [0,0,0,0,0,0];   %x,y,xp,yp,CAM                         
