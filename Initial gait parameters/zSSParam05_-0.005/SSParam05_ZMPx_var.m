function   Nao_param = SSParam05_ZMPx_var()
...
RShoulder_Pitch_f = 1.7;%q13 Q11
%\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
LShoulder_Pitch_i = 1.7;%q17 Q15
LShoulder_Pitch_f = 1.5;%q17 Q15
%\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
...
ZMPxEnd =  0;
ZMPyIni =  -0.005;      % Local position of the desired ZMP in Y for each step
ZMPyEnd =  -0.005;
Pos = [T1 ZMPxIni;       
       T2 ZMPxEnd];
Vel = [T1 0;    
