function   Nao_param = Param06_t_StartingDS_finalb()
...
ZMPxIni = 0.032498508746009;
ZMPxEnd = S-0.005;  
ZMPyIni = 0.019746830979695;
...
% Rcyc = [3.118349e-03,1.147949e-04,1.223058e-01,2.129874e-01]; %Param00_ZMP_var3
% Rcyc = [2.921858e-03,1.227186e-04,1.227944e-01,2.602501e-01]; %Param00_ZMP_var3
% Rcyc = [3.073614e-03,2.270968e-03,1.218660e-01,2.124650e-01]; % Param_var4 ZMPy 0 - 0.1 z=0.26
% Rcyc = [1.280275e-02,1.196618e-02,6.720861e-02,1.655144e-01];
...
% Rcyc = [0.013764121557655,0.011760441877202,0.076677203697916,0.139163235301039];
% Rcyc = [0.018265101798233,0.013886109534386,0.058367773809186,0.130504113454206];R
Rcyc = [0.018437984735629,0.013850018185894,0.058687858534872,0.130125701899677];
