function   Nao_param = SSParam11_ZMPx_var_Y_gait()
...
Rcyc = [-0.000732500809023,-0.000129209390674,0.105608705766145,0.103224543447813]; %Transition=true -S a S
% Rcyc = [-0.000732500809023,-0.000129209390674,-0.005608705766145,0.003224543447813]; %Transition=true 0 a 0
% Rcyc = [0,0,-0.09,0.01]; %Transition=false
