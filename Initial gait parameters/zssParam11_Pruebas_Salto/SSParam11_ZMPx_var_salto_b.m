function   Nao_param = SSParam11_ZMPx_var_salto_b()
...
S = 0;         % Step length 0.1
D = 0.1;        % Step width
a_z = -0.055;      % Maximum amplitude oscillation of the CoM
...
Rcyc = [0.001355550086520,-0.000020686754098,0.000022345314149,0.092963688133850]; %Transition=true 0_0 a_z=-0.04
