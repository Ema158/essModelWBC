function   Nao_param = testZeroQYZMP()
...
RShoulder_Pitch_i = 0.0;%q13 Q11
RShoulder_Pitch_f = 0.0;%q13 Q11
%\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
LShoulder_Pitch_i = 0.0;%q17 Q15
LShoulder_Pitch_f = 0.0;%q17 Q15
%\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
RShoulder_Yaw_i = -0.0;%q14 Q12
RShoulder_Yaw_f = -0.0;%q14 Q12
%\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
LShoulder_Yaw_i = 0.0;%q18 Q16
LShoulder_Yaw_f = 0.0;%q18 Q16
%\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
...
%\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
RElbow_Yaw_i = 0.0;%q16 Q14
RElbow_Yaw_f = 0.0;%q16 Q14
%\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
LElbow_Yaw_i = -0;%q20 Q18
LElbow_Yaw_f = -0.0;%q20 Q18
%\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
%Tiempos
T_midFoot=T/2;
T_midCoMz=T/2;
...
ZMPxIni =  -0.000000000000016;      % Local position of the desired ZMP in X for each step
ZMPxEnd =  -0.000000000000016;
ZMPyIni =  0.049998008588967;      % Local position of the desired ZMP in Y for each step
ZMPyEnd =  0.049998008588967;
% ZMPxIni =  0;      % Local position of the desired ZMP in X for each step
% ZMPxEnd =  0;
% ZMPyIni =  D/2;      % Local position of the desired ZMP in Y for each step
% ZMPyEnd =  D/2;
Pos = [T1 ZMPxIni;       
       T2 ZMPxEnd];
Vel = [T1 0
