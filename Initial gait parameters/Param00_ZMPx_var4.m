function   Nao_param = Param00_ZMPx_var4()
...
z0 = 0.26;       % hight of the CoM 0.27
g = 9.81;        % acceleration of gravity
% --------------
% RShoulder_Pitch_i = 1.6;%q13 Q11
% RShoulder_Pitch_f = 2.01;%q13 Q11
RShoulder_Pitch_i = 1.6;%q13 Q11
RShoulder_Pitch_f = 1.19;%q13 Q11
%\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
% LShoulder_Pitch_i = 1.6;%q17 Q15
% LShoulder_Pitch_f = 1.18;%q17 Q15
LShoulder_Pitch_i = 1.6;%q17 Q15
LShoulder_Pitch_f = 2.01;%q17 Q15
%\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
RShoulder_Yaw_i=0;%q14 Q12
RShoulder_Yaw_f=0;%q14 Q12
%\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
LShoulder_Yaw_i=0;%q18 Q16
LShoulder_Yaw_f=0;%q18 Q16
%\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
...
ZMPxIni =  -0.01;      % Local position of the desired ZMP in X for each step
ZMPxEnd =  0.02;
...
%Rcyc = [-1.384055e-03,2.604667e-04,1.585084e-01,2.369689e-01]; %Valores encontrados con el programa M40 para param00
%Rcyc = [8.922656e-03,2.630052e-04,2.687697e-02,2.392157e-01]; %Valores encontrados con M40 para param00_ZMPxvar
%Rcyc = [1.220938e-03,3.276052e-04,1.504558e-01,2.38634e-01];
%Rcyc = [3.847286e-03,5.525276e-04,1.167531e-01,2.138708e-1]; %Param00_ZMPx_var2() zmpy 0.1-0-0.1}
% Rcyc = [3.158604e-03,1.750177e-04,1.214229e-01,2.136317e-01];
% Rcyc = [3.123883e-03,1.475832e-04,1.222767e-01,2.130363e-01];
% Rcyc = [3.045347e-03,1.156665e-04,1.224178e-01,2.386784e-01]; %Param_var4
% Rcyc = [3.169939e-03,2.318507e-03,1.219743e-01,2.150089e-01]; % Param_var4 ZMPy 0 - 0.1 z = 0.255
