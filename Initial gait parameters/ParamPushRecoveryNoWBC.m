function   Nao_param = ParamPushRecoveryNoWBC()
...
RShoulder_Pitch_f = 1.8;%q13 Q11
%\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
LShoulder_Pitch_i = 1.8;%q17 Q15
LShoulder_Pitch_f = 1.8;%q17 Q15
%\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
RShoulder_Yaw_i=-0.15;%q14 Q12
RShoulder_Yaw_f=-0.15;%q14 Q12
%\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
LShoulder_Yaw_i=0.15;%q18 Q16
LShoulder_Yaw_f=0.15;%q18 Q16
%\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
...
gait_parameters.Hip_Pitch_f = 0.0;  % Final orientation of the hip around Z 
...
%Ganancias PD (No se usan pero genebot las pide)
Kp = 10*eye(12,12); %Bueno push recovery
Kd = 7*eye(12,12); %Bueno push recovery
Kz = 1; %Ganancia ZMP
...
gait_parameters.magnitudeDisturbance = 32; %Acc
...
Rcyc = [0.00,0,0.0,0,0,0];   %x,y,xp,yp,CAM                        
