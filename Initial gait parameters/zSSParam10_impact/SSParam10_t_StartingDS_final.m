function   Nao_param = SSParam10_t_StartingDS_final()
...
ZMPxIni = 0.005290567445291; %Transition = false
ZMPxEnd = S-0.005;  
% ZMPyIni = 0.001431706418219; %Transition = true
ZMPyIni = 0.001164698432327; %Transition = false
ZMPyMid = 0.0425; 
ZMPyEnd = D;  
Pos = [T1 ZMPxIni; 
%        T/2 ZMPxMid;
...
Rcyc = [0.001616728410185,0.000321849273708,0.113887541800797,0.237994429464940]; %Transition=false
