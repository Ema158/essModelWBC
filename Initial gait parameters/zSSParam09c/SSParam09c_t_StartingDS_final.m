function   Nao_param = SSParam09c_t_StartingDS_final()
...
ZMPxIni = 0.005820907691611; %Transition = false
ZMPxEnd = S-0.005;  
% ZMPyIni = 0.001431706418219; %Transition = true
ZMPyIni = 0.000203844781153; %Transition = false
ZMPyMid = 0.0425; 
ZMPyEnd = D;  
Pos = [T1 ZMPxIni; 
%        T/2 ZMPxMid;
...
Rcyc = [0.001072937190596,-0.000280927134872,0.111808390604678,0.246938414959610]; %Transition=false
