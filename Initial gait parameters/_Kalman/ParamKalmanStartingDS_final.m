function   Nao_param = ParamKalmanStartingDS_final()
...
ZMPxIni = -0.005529569056855; %Transition = false
ZMPxEnd = S;  
% ZMPyIni = 0.001431706418219; %Transition = true
ZMPyIni = -0.011587159189832; %Transition = false
ZMPyMid = 0.0425; 
ZMPyEnd = D;  
Pos = [T1 ZMPxIni; 
%        T/2 ZMPxMid;
...
Rcyc = [-0.000541489541048,0.000140204749650,0.163672382290534,0.240179349945926];
