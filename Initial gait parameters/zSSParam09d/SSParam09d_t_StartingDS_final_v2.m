function   Nao_param = SSParam09d_t_StartingDS_final_v2()
...
ZMPxIni = 0.004828792696219; %Transition = false
ZMPxEnd = S-0.005;  
% ZMPyIni = 0.001431706418219; %Transition = true
ZMPyIni = 0.008837251648514; %Transition = false
ZMPyMid = 0.0425; 
ZMPyEnd = D-0.008;  
Pos = [T1 ZMPxIni; 
%        T/2 ZMPxMid;
...
Rcyc = [0.000393588686420,-0.000244521503874,0.189143251016086,0.205941584048650]; %Transition=false
