function   Nao_param = Param69_t_StartingDS_final_circ_b()
...
Yaw_ffoot_f = deg2rad(10); % final orientation of the free foot w.r.t. the support frame (right foot) %Estos valores no se mandan!!!!!
...
% ZMPyEnd = D; 
%
ZMPxIni = -0.014371640842657; %0.25
ZMPxEnd = S-0.005;  
ZMPyIni = -0.005062760396503; %0.25
ZMPyMid = 0.0425; %Puede usarse o no
ZMPyEnd = D; 
Pos = [T1 ZMPxIni; 
%        T/2 ZMPxMid;
...
Rcyc = [-0.012731729552108,0.003805839981935,0.097341180363868,0.233315871612374]; % q6,q7   10 grados
