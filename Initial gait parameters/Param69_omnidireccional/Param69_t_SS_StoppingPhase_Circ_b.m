function   Nao_param = Param69_t_SS_StoppingPhase_Circ_b(rotated)
...
ZMPyi = 0; %not used
if rotated == true
    ZMPxi = 0.002203772436815;
    ZMPxf = 0.002462992182107;
    ZMPyf = 0.011469089946988;
else
    ZMPxi = 0.000493153366748;
    ZMPxf = 0.003428868317400;
    ZMPyf = 0.013872549795317;
end
% ---------------------------------------------------------------------
