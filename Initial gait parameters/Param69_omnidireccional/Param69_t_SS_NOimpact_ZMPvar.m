function   Nao_param = Param69_t_SS_NOimpact_ZMPvar()
...
Yaw_ffoot_i = deg2rad(-5); % Initial orientation of the free foot w.r.t. the support frame (right foot)
Yaw_ffoot_f = deg2rad(5); % final orientation of the free foot w.r.t. the support frame (right foot)
...
Rcyc = [0.003132260332515,0.010033025475821,0.114450774072767,0.177234089249763]; %ZMP -0.01_-0.01 h_f = 0.02
