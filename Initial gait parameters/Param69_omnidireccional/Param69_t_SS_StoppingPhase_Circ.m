function   Nao_param = Param69_t_SS_StoppingPhase_Circ(rotated)
...
% RotZ_01 = [cos(Yaw_ffoot_i), -sin(Yaw_ffoot_i); sin(Yaw_ffoot_i), cos(Yaw_ffoot_i)];
...
RShoulder_Pitch_i = 1.8;%q13 Q11
RShoulder_Pitch_f = 1.6;%q13 Q11
% RShoulder_Pitch_i = 1.6;%q13 Q11
% RShoulder_Pitch_f = 1.5;%q13 Q11
%\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
% LShoulder_Pitch_i = 1.6;%q17 Q15
% LShoulder_Pitch_f = 1.6;%q17 Q15
LShoulder_Pitch_i = 1.4;%q17 Q15
LShoulder_Pitch_f = 1.6;%q17 Q15
%\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
...
RElbow_Yaw_f=0.15;%q16 Q14
%\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
% LElbow_Yaw_i=-0.2;%q20 Q18
% LElbow_Yaw_f=-0.2;%q20 Q18
LElbow_Yaw_i=-0.4;%q20 Q18
LElbow_Yaw_f=-0.4;%q20 Q18
%\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
%Tiempos
T_midFoot=T/2;
T_midCoMz=T/2;
...
ZMPyi = 0; %not used
if rotated == true
    ZMPxi = -0.029388367516737;
    ZMPxf = 0.018665862533457;
    ZMPyf = -0.010997228178929;
else
    ZMPxi = 0.000425273695956;
    ZMPxf = 0.003469200608914;
    ZMPyf = 0.013849722063113;
%     ZMPxi = -0.016409040132403;
%     ZMPxf = 0.012387074826520;
%     ZMPyf = -0.016204614919833;
end
% ---------------------------------------------------------------------
...
gait_parameters.ZMPxMid = ZMPxMid;
...
Rcyc = [0.013234087227064,0.014903196111182,0.0585051253527,0.169639636131328];
