function   Nao_param = Param69_t_DS_StoppingPhase_Circ(rotated)
...
ZMPxi = 0.012; %no se usa
ZMPxf = 0;
ZMPyf = D/2;
if rotated ==true
    ZMPx0 =  0.018665862533457;  
    ZMPy0 = -0.010997228178929;                 
    ZMPyi = 0.092926533016323;
else
    ZMPx0 = 0.003469200608914;  
    ZMPy0 = 0.013849722063113;                  
    ZMPyi = 0.078064527651806;
%     ZMPx0 = 0.012387074826520;  
%     ZMPy0 = -0.016204614919833;                  
%     ZMPyi = 0.096147656090738;
end
