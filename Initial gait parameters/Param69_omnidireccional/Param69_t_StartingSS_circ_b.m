function   Nao_param = Param69_t_StartingSS_circ_b()
...
Yaw_ffoot_f = deg2rad(10); % final orientation of the free foot w.r.t. the support frame (right foot)
...
RShoulder_Pitch_i = 1.6;%q13 Q11
RShoulder_Pitch_f = 1.4;%q13 Q11
%\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
LShoulder_Pitch_i = 1.6;%q17 Q15
LShoulder_Pitch_f = 1.8;%q17 Q15
%\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
...
%\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
RElbow_Yaw_i = 0.15;%q16 Q14
RElbow_Yaw_f = 0.4;%q16 Q14
%\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
LElbow_Yaw_i=-0.4;%q20 Q18
LElbow_Yaw_f=-0.15;%q20 Q18
%\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
%Tiempos
T_midFoot=T/2;
T_midCoMz=T/2;
...
ZMPx0 = 0.000411390737720;  %0.25
ZMPxf = -0.014371640842657;  %0.25   q6 q7
ZMPy0 = 0.024354460599986;   %0.25
ZMPyi = 0;
ZMPyf = -0.005062760396503; %0.25
%
% ZMPx0 = 0.000484500026677;  %0.25
% ZMPxf = -0.014825818970788;  %0.25
% ZMPy0 = 0.024252506495866;   %0.25
% ZMPyi = 0;
% ZMPyf = -0.004678736484121; %0.25
% %
% ZMPx0 = 0.000448327196160;  %0.25
% ZMPxf = -0.013408679498903;  %0.25
% ZMPy0 = 0.024149153371264;   %0.25
% ZMPyi = 0;
% ZMPyf = -0.004364281434113; %0.25
% ---------------------------------------------------------------------
