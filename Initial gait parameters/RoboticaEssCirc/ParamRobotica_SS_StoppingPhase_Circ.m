function   Nao_param = ParamRobotica_SS_StoppingPhase_Circ(rotated)
...
ZMPyi = 0; %not used
if rotated == true
    ZMPxi = 0.001339204818712;
    ZMPxf = 0.003805601673286;
    ZMPyf = -0.001049320960166;
else
    ZMPxi =  0.000473151614914;
    ZMPxf =  0.004564496116212;
    ZMPyf = 0.001521648134709;
end
% ---------------------------------------------------------------------
