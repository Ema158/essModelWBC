function   Nao_param = ParamRobotica_DS_circ_Step2()
...
% ZMPx0 =  -0.005; 
ZMPx0 = 0; 
ZMPxf = ffoot_pos_f_1(1) - 0.005;
ZMPy0 = 0;
ZMPyi = 0;
ZMPyf = ffoot_pos_f_1(2);
% ZMPyf = 0.011;
% ---------------------------------------------------------------------
...
gait_parameters.x_ffoot_i = -S + Step_length_1;      % Initial step position in X
gait_parameters.x_ffoot_f = -S + Step_length_1;   % Distance traveled in X by the free foot to reach the final position in X
gait_parameters.y_ffoot_i = D + wide_error_1;       % Initial step position in Y
gait_parameters.y_ffoot_f = D + wide_error_1;      % Distance traveled in Y by the free foot to reach the final position in Y
...
% Rcyc =
% Rcyc = [-0.008496364150668,0.002137064191023,0.119090167432660,0.226119974637693]; % q6,q7   5 grados
% Rcyc = [-0.013667002010976,0.006182570707961,0.1621118041254171,0.260973214454775]; % q6,q7   10 grados 
