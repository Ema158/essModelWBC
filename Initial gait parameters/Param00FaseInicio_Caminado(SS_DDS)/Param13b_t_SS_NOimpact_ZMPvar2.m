function   Nao_param = Param13b_t_SS_NOimpact_ZMPvar2()
...
% Rcyc = [-1.384055e-03,2.604667e-04,1.845084e-06,2.369689e-01]; %Valores encontrados con el programa M40
% Rcyc = [3.073614e-03,2.270968e-03,1.258660e-01,2.204650e-01]; % Param_var4 ZMPy 0 - 0.1 z=0.26
% Rcyc = [8.633476e-03,1.201813e-02,9.398467e-02,1.661550e-01]; % Valores optimizados de param_var4 con SS DS
% Rcyc = [1.199074e-02,1.197941e-02,9.848031e-02,1.657027e-01]; % Antes del cambio de q15-q19
