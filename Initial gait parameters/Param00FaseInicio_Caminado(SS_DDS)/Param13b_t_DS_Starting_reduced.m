function   Nao_param = Param13b_t_DS_Starting_reduced()
...
ZMPxIni = -0.007043299832976;
ZMPxEnd = S-0.005;  
ZMPyIni = -0.051623373969419;
ZMPyMid = 0.005; 
ZMPyEnd = D;  
Pos = [T1 ZMPxIni; 
%        T/2 ZMPxMid;
...
Rcyc = [0.011901906617708,0.011971416392387,0.098136021929343,0.165271424404959];
