function   Nao_param = Param31_t_StartingDS_final()
...
ZMPxIni = 0.021442004521248; %ZMP -0.01_-0.01 h_f = 0.02
ZMPxEnd = S-0.005;  
% ZMPyIni = -0.000441864635570; %ZMP 0_0 h_f = 0.02
ZMPyIni = 0.045562747601498; %ZMP -0.01_-0.01 h_f = 0.02
...
Rcyc = [0.012259109796657,0.028797726122206,0.059821000064923,0.101866613191347]; %ZMP -0.01_-0.01 h_f = 0.02
