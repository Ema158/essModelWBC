function   Nao_param = SSParam13_ZMPx_var_Internal_State_x()
...
% Rcyc = [-0.004084335506638,0.000211470199151,0.275779937828440,0.124612918650020]; %Transition=false  zmpx 0_0.01
Rcyc = [-0.001684335506858,0.000100673475611,0.150446718471896,0.260059766175735]; %Transition=false  zmp_0_0
%% Gait parameters 
% ============================
T = 0.714406;         % Time step
% T = 0.6;         % Time step
...
% 2 -> Controlled variables defined by polynomials w.r.t. "x" of the CoM, IMPACT can be considered. Files: "hd_Polyn", "hpd_Polyn_x" and "hppd_Polyn_x". 
OptionContVar = 2;
% -------------------------------------------------------------------------------------------------
...
% Rcyc = [0.001127357616369,0.000097657393959,0,0.238285372130439]; %Transition=false
