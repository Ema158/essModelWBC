function   Nao_param = SSParam13_t_StartingDS()
...
ZMPxi = 0;
% ZMPxf = -0.000664027020571; %ZMPy 0
ZMPxf = -0.000670651595503; %ZMPy 0.005
ZMPy0 = D/2;
ZMPyi =  0.075; %0.25
% ZMPyi =  0.09; %t_0.15 
% ZMPyf = 0.021725716509026; %ZMPy 0
ZMPyf = 0.021341296074250; %ZMPy 0.005
% ---------------------------------------------------------------------
