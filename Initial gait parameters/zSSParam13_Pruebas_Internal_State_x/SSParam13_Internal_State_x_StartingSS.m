function   Nao_param = SSParam13_Internal_State_x_StartingSS()
...
%
x_event = 0.000118;
% x_event_SS = x_event + S/2;
x_event_SS = x_event + S/2 - 0.003; %%%%%%%%%%%%%Duda (El -0.003 es arbitrario)
% --------------
...
ZMPx0 = -0.000569231413895;  %%xmid = 0.009
% ZMPx0 = -0.000568412146511; %%xmid=S/4
ZMPxf = -0.003032775866877;  %%xmid = 0.009
% ZMPxf = -0.003222674007261;  %%xmid=S/4
ZMPy0 = 0.009029634732161;    %%xmid = 0.009
% ZMPy0 = 0.008722968296536;   %%xmid=S/4
ZMPyi = 0;
ZMPyf = -0.012264933492947;  %%xmid = 0.009
% ZMPyf = -0.012528491986582;  %%xmid=S/4
% ---------------------------------------------------------------------
...
%Pitch del pie en t=T_midFoot
gait_parameters.x0 = x_event;
gait_parameters.xf = x_event_SS;
%
