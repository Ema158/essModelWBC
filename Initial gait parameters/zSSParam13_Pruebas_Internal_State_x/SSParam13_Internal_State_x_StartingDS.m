function   Nao_param = SSParam13_Internal_State_x_StartingDS()
...
%
Rcyc = [-0.001684335506859,0.000100673475611,0.150446718471930,0.260059766175627]; %Transition=false 
%
...
ZMPxi = 0;
ZMPxf = -0.000569231413895; %%xmid = 0.009
% ZMPxf = -0.000568412146511; %xmid=S/4
ZMPy0 = D/2;
ZMPyi =  0.075; %0.25
% ZMPyi =  0.09; %t_0.15 
ZMPyf = 0.009029634732161; %%xmid = 0.009
% ZMPyf = 0.008722968296536; %xmid=S/4
% ---------------------------------------------------------------------
...
%Pitch del pie en t=T_midFoot
gait_parameters.x0 = 0;
gait_parameters.xmid = xmid_event;
gait_parameters.xf = x_event;
%
