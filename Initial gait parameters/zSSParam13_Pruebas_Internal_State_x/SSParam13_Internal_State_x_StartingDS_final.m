function   Nao_param = SSParam13_Internal_State_x_StartingDS_final()
...
gait_parameters.x0 = x_event_SS;
gait_parameters.xf = xfc;
%
Pitch_ffoot_inc=0;
%% Desired ZMP
% =========================================
...
ZMPxIni = -0.003032775866877; %%xmid = 0.009
% ZMPxIni = -0.003222674007261; %%xmid=S/4
ZMPxEnd = S;  
ZMPyIni = -0.012264933492947; %%xmid = 0.009
% ZMPyIni = -0.012528491986582; %%xmid=S/4
ZMPyMid = 0.0425; %Puede usarse o no
ZMPyEnd = D;  
% ZMPyEnd = D; %ZMP 0_0 h_f = 0.02
Pos = [x_event_SS ZMPxIni; 
%        T/2 ZMPxMid;
       xfc ZMPxEnd];
Vel = [];
Acc = [];
ZMPxCoeff = findPolyCoeff(Pos,Vel,Acc);
Pos = [x_event_SS ZMPyIni; 
%         T/2 ZMPyMid;
       xfc ZMPyEnd];     
...
% Rcyc = [-0.001684335506859,0.000100673475611,0.150446718471930,0.260059766175627]; %Transition=false 
% %ZMPy 0.005
% Rcyc = [0.009441399433565,0.010295049471527,0.159644132451924,0.180579029941220]; %ZMPy 0
