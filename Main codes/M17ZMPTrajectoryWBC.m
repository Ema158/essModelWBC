...
% Parameters
% ---------------------------------------------------------
Nao_param = ParamZMPTrajectoryWBCv2();
% ---------------------------------------------------------
...
[robot.Zref,robot.tRef] = ZMPReferenceTrajectoryV2(horizon,muestrasTotal);
% robot.ZMax = robot.Zref + [0.0055;0.0055]; %0.006
% robot.ZMin = robot.Zref - [0.0055;0.0055];  %0.006
...
[t,Xt,SupportFoot] = EssModelWbcZMPTrajectoryAcc(X_final,gait_parameters);
%% =====================================
% Plots
% =============
