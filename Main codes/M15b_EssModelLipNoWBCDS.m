...
% GENERAL OPTIONS
% ----------------------------------------------------
DataName = 'InfoNAO_Param_t_caminadoNoWBCDS';
...
disp('-------------------------------------------');
X_final = [0;D/2;xpf;ypf];
[tStart,tStartStep,tStop,tStopStep,tSS,tDS,XtStart,XtStartStep,XtStop,XtStopStep,XtSS,XtDS,SupportFoot] = EssModelWbcLipOnlineJerkNoWBCDS(X_final,gait_parametersSS,gait_parametersDS,gait_parametersStart,gait_parametersStartStep,gait_parametersStop,gait_parametersStopStep,N,horizon);
%% =====================================
% Plots
% =============
