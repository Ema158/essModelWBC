...
for j=1:N    
    ...
    q13f = Xt{j}(end,3); q13pf = Xt{j}(end,15);
    q14f = Xt{j}(end,4); q14pf = Xt{j}(end,16);
    q15f = Xt{j}(end,5); q15pf = Xt{j}(end,17);
    q16f = Xt{j}(end,6); q16pf = Xt{j}(end,18);
    q17f = Xt{j}(end,7); q17pf = Xt{j}(end,19);
    q18f = Xt{j}(end,8); q18pf = Xt{j}(end,20);
    q19f = Xt{j}(end,9); q19pf = Xt{j}(end,21);
    q20f = Xt{j}(end,10); q20pf = Xt{j}(end,22);
    Rollf = Xt{j}(end,11); Rollpf = Xt{j}(end,23);
    Pitchf = Xt{j}(end,12); Pitchpf = Xt{j}(end,24);
    % Display information
    % ----------------------------------------------------    
    fprintf('Step %d of %d\n',j,N);   
...
for j=1:N    
    ...
    if mod(j,2) % If j is impair (for pair steps we add distance D and invert direction)    
        ...
        ypt = Xt{j}(:,14)';                       % global velocity yp(t) for step "j" 
    else
        yt = SupportFoot{j}(2) - Xt{j}(:,2)';  % global position of y(t) for step "j"
        ypt = -Xt{j}(:,14)';                       % global velocity yp(t) for step "j" 
    end
    xpt = Xt{j}(:,13)';                       % xp(t) for step "j"     
