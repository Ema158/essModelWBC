...
% Parameters
% ---------------------------------------------------------
Nao_param = ParamStandingOneFoot();
% ---------------------------------------------------------
...
% GENERAL OPTIONS
% ----------------------------------------------------
DataName = 'InfoNAO_Param_t_10prueba4';
...
disp('-------------------------------------------');
X_final = [0.00;0.02;q13f;q14f;q15f;q16f;q17f;q18f;q19f;q20f;Rollf;Pitchf;...
               xpf;ypf;q13pf;q14pf;q15pf;q16pf;q17pf;q18pf;q19pf;q20pf;Rollpf;Pitchpf];
[t,Xt,SupportFoot] = EssModelWbcStandingOneFoot(X_final,gait_parameters,N,robot,horizon);
%% =====================================
% Plots
% =============
