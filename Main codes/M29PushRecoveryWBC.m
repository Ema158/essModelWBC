...
%     X0 = Xt{j}(1,:); % Initial condition of the CoM
    ...
    [qt,qDt,qDDt] = joints_fromCoMpos_Vel_HZDtime(robot,Xt,gait_parameters,t);
    samples = size(t,2);
    % ------------------------------------------------    
    ...
    for i = 1:samples
        ...
        CAM(3,i) = (ZMP(1,i)-Xt(i,1))*F(2,i) - (ZMP(2,i)-Xt(i,2))*F(1,i);
    end
...
if anim    
    ...
    n = 25; % Number of samples of vector
...
hold on
plot(t,polyval(gait_parameters.CAMpxCoeff,t))
figure(32)
plot(t,CAM(2,:))
title('Angular Momentum rate change in y');
hold on
plot(t,polyval(gait_parameters.CAMpyCoeff,t))
figure(33)
plot(t,CAM(3,:))
title('Angular Momentum rate change in z');
figure(34)
plot(t,CMP(1,:))
hold on
plot(t,ZMP(1,:))
...
hold on
plot(t,polyval(gait_parameters.CAMyCoeff,t))
figure(37)
plot(t,Xt(:,25))
title('Angular Momentum in x');
hold on
plot(t,polyval(gait_parameters.CAMxCoeff,t))
%% End of the code
% ----------------------------------------------------------------------------------------------
