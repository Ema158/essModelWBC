...
% Parameters
% ---------------------------------------------------------
Nao_param = ParamZMPTrajectoryNoWBC();
% ---------------------------------------------------------
...
% GENERAL OPTIONS
% ----------------------------------------------------
DataName = 'InfoNAO_ZMPTrajectoryNoWBC';
...
robot.ZMax = robot.Zref + [0.0075;0.0075]; %0.007738
robot.ZMin = robot.Zref - [0.0075;0.0075]; %0.007738
% robot.ZMax = robot.Zref + [0.1;0.1]; %0.007738
% robot.ZMin = robot.Zref - [0.1;0.1]; %0.007738
...
disp('-------------------------------------------');
X_final = [0;0.05;xpf;ypf;CAMxf;CAMyf];
[t,Xt,SupportFoot] = EssModelZMPTrajectoryNoWBCAcc(X_final,gait_parameters);
%% =====================================
