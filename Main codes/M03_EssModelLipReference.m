...
[tref,XrefLip,ZMPrefLip] = MpcLIP(gait_parameters,[0;D/2;xpf;ypf],N);
ZMPrefLipCopy = ZMPrefLip;
...
[tStart,tStartStep,tStop,tStopStep,t,XtStart,XtStartStep,XtStop,XtStopStep,Xt,SupportFoot] = robot_step_EssModel_StartGaitStop(X_final,gait_parameters_gait,gait_parametersStart,gait_parametersStartStep,gait_parametersStop,gait_parametersStopStep,N);
%% =====================================
% Plots
% =============
