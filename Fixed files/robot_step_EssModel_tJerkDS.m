...
function [tSS,tDS,XtSS,XtDS] = robot_step_EssModel_tJerkDS(X_final,gait_parametersSS,gait_parametersDS)
...
[XtSS] = ode4(@dynam_HZDtimeLipReferenceOnlineJerkSS,0:1e-2:gait_parametersSS.T,X0);
tSS = 0:1e-2:gait_parametersSS.T;
X0 = XtSS(end,:)';
gait_parameters = gait_parametersDS;
[XtDS] = ode4(@dynam_HZDtimeLipReferenceOnlineJerkDS,0:1e-2:gait_parametersDS.T,X0);
