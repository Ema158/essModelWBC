function [tStart,tStartStep,tStop,tStopStep,t,XtStart,XtStartStep,XtStop,XtStopStep,Xt,SupportFoot] = EssModelWbcLipOnlineJerk(X0,gait_parameters_gait,gait_parametersStart,gait_parametersStartStep,gait_parametersStop,gait_parametersStopStep,N,robot,horizon)
...
for j=1:N    
    ...
    % ====================================================================
    [t{j},X0,Xt{j}] = robot_step_EssModel_tJerk(X_final); % "robot" and "gait_parameters" structures are needed inside
%     for i=1:length(t{j})
