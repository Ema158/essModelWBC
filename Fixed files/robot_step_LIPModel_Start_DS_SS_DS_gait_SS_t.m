function [t_gait,Xt_gait,t_SS,Xt_SS,t_DS,Xt_DS,t_DS_final,Xt_DS_final,gait_parameters_SS,gait_parameters_DS,gait_parameters_DS_final,gait_parameters_gait_SS] = ...
    robot_step_LIPModel_Start_DS_SS_DS_gait_SS_t(gait_parameters_SS,gait_parameters_DS,gait_parameters_DS_final,gait_parameters_gait_SS,N)
...
for j=1:N    
    ...
    [t_gait{j},Xt_gait{j}] = Nsteps_3DLIP_model_v2(X_final); % "robot" and "gait_parameters" structures are needed inside
