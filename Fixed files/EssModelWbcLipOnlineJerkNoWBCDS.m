function [tStart,tStartStep,tStop,tStopStep,tSS,tDS,XtStart,XtStartStep,XtStop,XtStopStep,XtSS,XtDS,SupportFoot] = EssModelWbcLipOnlineJerkNoWBCDS(X0,gait_parametersSS,gait_parametersDS,gait_parametersStart,gait_parametersStartStep,gait_parametersStop,gait_parametersStopStep,N,horizon)
...
for j=1:N    
    ...
    % ====================================================================
    [tSS{j},tDS{j},XtSS{j},XtDS{j}] = robot_step_EssModel_tJerkNoWBCDS(X_final,gait_parametersSS,gait_parametersDS); % "robot" and "gait_parameters" structures are needed inside
    % Final states:
    X_final = XtDS{j}(end,:)';
    disp('-------------------------------------------');
