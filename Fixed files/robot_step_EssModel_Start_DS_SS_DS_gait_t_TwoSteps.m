...
function [t,Xt,t_SS,Xt_SS,t_DS,Xt_DS,t_DS_final,Xt_DS_final,gait_parameters_SS,gait_parameters_DS,gait_parameters_DS_final,gait_parameters_gait_SS_Step1,gait_parameters_gait_SS_Step2] = robot_step_EssModel_Start_DS_SS_DS_gait_t_TwoSteps(gait_parameters_SS,gait_parameters_DS,gait_parameters_DS_final,gait_parameters_gait_SS_Step1,gait_parameters_gait_SS_Step2,N)
...
for j=1:N    
    ...
    if mod(j,2)==1
        gait_parameters = gait_parameters_gait_SS_Step1;
        gait_parameters_PreviousStep = gait_parameters_gait_SS_Step2;
        gait_parameters_CurrentStep = gait_parameters_gait_SS_Step1;
    else
        gait_parameters = gait_parameters_gait_SS_Step2;
        gait_parameters_PreviousStep = gait_parameters_gait_SS_Step1;
        gait_parameters_CurrentStep = gait_parameters_gait_SS_Step2;
    end
    T = gait_parameters.T;
    g = gait_parameters.g;
    z0 = gait_parameters.z_i;
...
%     [t{j},X0,Xt{j}] = robot_step_EssModel_t(X_final); % "robot" and "gait_parameters" structures are needed inside
    [t{j},X0,Xt{j}] = robot_TwoDiffSteps_EssModel_t(X_final,gait_parameters_CurrentStep,gait_parameters_PreviousStep); % "robot" structures are needed inside
