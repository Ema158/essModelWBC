...
function [ XD ] = dynam_HZDtimeLipReferenceOnlineJerkNoWBC(t,X)
...
% [Xref,ZMPRef] = MpcLIPOnlineJerk(gait_parameters,[x;y;xp;yp;xpp(1);xpp(2)],robot.Zref,k,robot.Px,robot.Pu);
[Xref,ZMPRef] = MpcLIPOnlineJerkConstraints(gait_parameters,[x;y;xp;yp;xpp(1);xpp(2)],robot.Zref,k,robot.Px,robot.Pu);
