function [qfpp, JPhi, JPhipPhip, qfp, tau] = Desired_qfpp_HZDtimeQPLipReferenceNoWBCTorque(ZMPd,robot_i,X,gait_param_i,t)
...
qfpp = -DrBar\HrBar;
%
tau = DeBar(7:end,:)*qfpp + HeBar(7:end);
if abs(t-0.2)<1e-6&&gait_parameters.boolDisturbance==1
