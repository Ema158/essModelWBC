...
function [ XD ] = dynam_HZDtimeLipReferenceOnlineJerkNoWBCSS(t,X)
...
%     xpp(2) = xpp(2) + Fy/m;
% end
[Xref,ZMPRef] = MpcLIPOnlineJerkConstraintsSS(gait_parameters,[x;y;xp;yp;xpp(1);xpp(2)],robot.Zref,robot.ZMax,robot.ZMin,k,robot.Px,robot.Pu);
