function [qfpp, JPhi, JPhipPhip, NE1, NE2, NE3, qfp] = Desired_qfpp_HZDtimeQP(ZMPd,robot_i,X,gait_param_i,t)
...
Q(11,11) = 0.00000000001; %0.01
Q(12,12) = 0.00000000001; %0.01
A = DrBar;
b = -HrBar;
options = optimset('Display', 'off');
%
alpha = 0.0001;
Qnew = alpha*(DrBar'*DrBar) + Q;
pnew = alpha*(DrBar'*HrBar);
qfpp = quadprog(Q,[],[],[],A,b,[],[],[],options);
% qfpp = quadprog(Qnew,pnew,[],[],[],[],[],[],[],options);
% qfpp(3:end) = -qfpp(3:end);
ema = 1;
% qfpp = -DrBar\HrBar;
