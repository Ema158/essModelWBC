...
function [ XD ] = dynam_HZDtimeLipReferenceOnlineAccNoWBCDS(t,X)
...
[Xref,ZMPRef] = MpcLIPOnlineAccConstraintsV2time(gait_parameters,[x;y;xp;yp],robot.Zref,robot.ZMax,robot.ZMin,k,robot.Px,robot.Pu);
