function [qfpp, JPhi, JPhipPhip, NE1, NE2, NE3, qfp] = Desired_qfpp_HZDtimeCAMTest(xRef,ZMPd,CAMd,robot_i,X,gait_param_i,t)
...
Acam = [Deltay*DeBar(3,:) + DeBar(2,:)*z;
      -Deltax*DeBar(3,:) - DeBar(1,:)*z];
bcam = [Deltay*HeBar(3) + z*HeBar(2) - CAMd(1);
       -Deltax*HeBar(3) - z*HeBar(1) - CAMd(2)];
%
A = [Azmp;Acam];
b = [bzmp;-bcam];
qfpp = quadprog(Q,[],[],[],A,b,[],[],[],options); 
% if t==0
%     qfpp(1) = qfpp(1) - 10;
% end
