function qfpp = Desired_qfppDS_newConstraint(xRef,ZMPd,robot_i,X,gait_param_i,t)
...
%
Aess(1,17) = Aess(1,17) - 1;
Aess(1,13) = Aess(1,13) + (ZMPd_x-p14(1));
Aess(2,18) = Aess(2,18) + 1;
Aess(2,13) = Aess(2,13) + (p14(2)-ZMPd_y);
