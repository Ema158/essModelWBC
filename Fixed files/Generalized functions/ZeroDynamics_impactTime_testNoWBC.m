function [Qplus,QPplus,ErrorQ, ErrorQp] = ZeroDynamics_impactTime_testNoWBC(x0,y0,qfp0,robot,gait_parameters)
...
t0 = 0;
qf0 = [x0;y0];
[Qplus_d, QPplus_d] = current_desired_states_PhiNoWBC(qf0,qfp0,gait_parameters,t0);
