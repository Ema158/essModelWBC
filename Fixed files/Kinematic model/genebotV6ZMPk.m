function robot = genebotV6ZMPk(gait_parameters,N)
...
robot.Px = Px;
robot.Pu = Pu;
robot.Kp = gait_parameters.Kp;
robot.Kd = gait_parameters.Kd;
robot.Kz = gait_parameters.Kz;
robot.KpCAM = gait_parameters.KpCAM;
end
