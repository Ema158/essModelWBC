...
function [tSS,tDS,XtSS,XtDS] = robot_step_EssModel_tAccNoWBCDS(X_final,gait_parametersSS,gait_parametersDS)
...
X0 = [robot.CoM(1:2); xp0; yp0; CAMx0; CAMy0];
% % -----------------------------------------------------------------------------------------------
% % ----------------------------------------------------------------------------------------------------
gait_parameters = gait_parametersSS;
XtSS = ode4(@dynam_HZDtimeLipReferenceOnlineAccNoWBCSS,0:1e-2:gait_parametersSS.T,X0);
tSS = 0:1e-2:gait_parametersSS.T;
X0 = XtSS(end,:)';
gait_parameters = gait_parametersDS;
XtDS = ode4(@dynam_HZDtimeLipReferenceOnlineAccNoWBCDS,0:1e-2:gait_parametersDS.T,X0);
