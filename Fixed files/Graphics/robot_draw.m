function robot_draw(robot,x0,y0,alpha)
...
XAVG = RotZ_01_4x4*T(:,:,13)*[-0.0460; -0.025; 0.1; 1]+[x0;y0;0;0];%* Cambie el valor de -0.0674 a -0.04660
XAVD = RotZ_01_4x4*T(:,:,13)*[-0.0460; +0.025; 0.1; 1]+[x0;y0;0;0];%*
XARD = RotZ_01_4x4*T(:,:,13)*[-0.0460; +0.025; -0.055; 1]+[x0;y0;0;0];%*
XARG = RotZ_01_4x4*T(:,:,13)*[-0.0460; -0.025; -0.055; 1]+[x0;y0;0;0];%*
% Como deberia ser
% XAVG(3)=0;
% XAVD(3)=0;
% XARG(3)=0;
...
for i = 20:24
 ...
 pm = RotZ_01_3x3*[xm;ym;zm] + [x0;y0;0];
