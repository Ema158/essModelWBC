function [t,Xt,SupportFoot] = EssModelWbcStandingOneFootNoWBC(X0,gait_parameters,N,robot,horizon)
global robot xpp
t = cell(1,N);
Xt = cell(1,N); 
...
for j=1:N    
    ...
    Xt{j} = ode4(@dynam_HZDtimeLipReferenceOnlineJerkNoWBC,0:1e-2:T,X_final);
    t{j} = 0:1e-2:T;
